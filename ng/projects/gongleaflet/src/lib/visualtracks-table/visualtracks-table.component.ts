...
export class VisualTracksTableComponent implements OnInit {
  ...
  selection: SelectionModel<VisualTrackDB> = new (SelectionModel)
  initialSelection = new Array<VisualTrackDB>()

  // the data source for the table
  visualtracks: VisualTrackDB[] = []
  matTableDataSource: MatTableDataSource<VisualTrackDB> = new (MatTableDataSource)
  ...
  save() {
    ...
    if (this.mode == TableComponentMode.MANY_MANY_ASSOCIATION_MODE) {
      ...
      if (sourceInstance[this.dialogData.SourceField as keyof typeof sourceInstance] == undefined) {
        (sourceInstance[this.dialogData.SourceField as keyof typeof sourceInstance] as unknown as Array<VisualTrackDB>) = new Array<VisualTrackDB>()
      }
