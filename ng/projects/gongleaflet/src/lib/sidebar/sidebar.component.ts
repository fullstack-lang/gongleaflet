      ...
      */
      ...
      this.frontRepo.VisualMaps_array.forEach(
        visualmapDB => {
          ...
          // insertion point for per field code
          /**
          * let append a node for the slide of pointer VisualCenters
          */
          let VisualCentersGongNodeAssociation: GongNode = {
            name: "(VisualCenter) VisualCenters",
            type: GongNodeType.ONE__ZERO_MANY_ASSOCIATION,
            id: visualmapDB.ID,
            uniqueIdPerStack: 19 * nonInstanceNodeId,
            structName: "VisualMap",
            associationField: "VisualCenters",
            associatedStructName: "VisualCenter",
            children: new Array<GongNode>()
          }
          nonInstanceNodeId = nonInstanceNodeId + 1
          visualmapGongNodeInstance.children.push(VisualCentersGongNodeAssociation)

          visualmapDB.VisualCenters?.forEach(visualcenterDB => {
            let visualcenterNode: GongNode = {
              name: visualcenterDB.Name,
              type: GongNodeType.INSTANCE,
              id: visualcenterDB.ID,
              uniqueIdPerStack: // godel numbering (thank you kurt)
                7 * getVisualMapUniqueID(visualmapDB.ID)
                + 11 * getVisualCenterUniqueID(visualcenterDB.ID),
              structName: "VisualCenter",
              associationField: "",
              associatedStructName: "",
              children: new Array<GongNode>()
            }
            VisualCentersGongNodeAssociation.children.push(visualcenterNode)
          })

          /**
          * let append a node for the slide of pointer VisualCircles
          */
          let VisualCirclesGongNodeAssociation: GongNode = {
            name: "(VisualCircle) VisualCircles",
            type: GongNodeType.ONE__ZERO_MANY_ASSOCIATION,
            id: visualmapDB.ID,
            uniqueIdPerStack: 19 * nonInstanceNodeId,
            structName: "VisualMap",
            associationField: "VisualCircles",
            associatedStructName: "VisualCircle",
            children: new Array<GongNode>()
          }
          nonInstanceNodeId = nonInstanceNodeId + 1
          visualmapGongNodeInstance.children.push(VisualCirclesGongNodeAssociation)

          visualmapDB.VisualCircles?.forEach(visualcircleDB => {
            let visualcircleNode: GongNode = {
              name: visualcircleDB.Name,
              type: GongNodeType.INSTANCE,
              id: visualcircleDB.ID,
              uniqueIdPerStack: // godel numbering (thank you kurt)
                7 * getVisualMapUniqueID(visualmapDB.ID)
                + 11 * getVisualCircleUniqueID(visualcircleDB.ID),
              structName: "VisualCircle",
              associationField: "",
              associatedStructName: "",
              children: new Array<GongNode>()
            }
            VisualCirclesGongNodeAssociation.children.push(visualcircleNode)
          })

          /**
          * let append a node for the slide of pointer VisualLines
          */
          let VisualLinesGongNodeAssociation: GongNode = {
            name: "(VisualLine) VisualLines",
            type: GongNodeType.ONE__ZERO_MANY_ASSOCIATION,
            id: visualmapDB.ID,
            uniqueIdPerStack: 19 * nonInstanceNodeId,
            structName: "VisualMap",
            associationField: "VisualLines",
            associatedStructName: "VisualLine",
            children: new Array<GongNode>()
          }
          nonInstanceNodeId = nonInstanceNodeId + 1
          visualmapGongNodeInstance.children.push(VisualLinesGongNodeAssociation)

          visualmapDB.VisualLines?.forEach(visuallineDB => {
            let visuallineNode: GongNode = {
              name: visuallineDB.Name,
              type: GongNodeType.INSTANCE,
              id: visuallineDB.ID,
              uniqueIdPerStack: // godel numbering (thank you kurt)
                7 * getVisualMapUniqueID(visualmapDB.ID)
                + 11 * getVisualLineUniqueID(visuallineDB.ID),
              structName: "VisualLine",
              associationField: "",
              associatedStructName: "",
              children: new Array<GongNode>()
            }
            VisualLinesGongNodeAssociation.children.push(visuallineNode)
          })

          /**
          * let append a node for the slide of pointer VisualTracks
          */
          let VisualTracksGongNodeAssociation: GongNode = {
            name: "(VisualTrack) VisualTracks",
            type: GongNodeType.ONE__ZERO_MANY_ASSOCIATION,
            id: visualmapDB.ID,
            uniqueIdPerStack: 19 * nonInstanceNodeId,
            structName: "VisualMap",
            associationField: "VisualTracks",
            associatedStructName: "VisualTrack",
            children: new Array<GongNode>()
          }
          nonInstanceNodeId = nonInstanceNodeId + 1
          visualmapGongNodeInstance.children.push(VisualTracksGongNodeAssociation)

          visualmapDB.VisualTracks?.forEach(visualtrackDB => {
            let visualtrackNode: GongNode = {
              name: visualtrackDB.Name,
              type: GongNodeType.INSTANCE,
              id: visualtrackDB.ID,
              uniqueIdPerStack: // godel numbering (thank you kurt)
                7 * getVisualMapUniqueID(visualmapDB.ID)
                + 11 * getVisualTrackUniqueID(visualtrackDB.ID),
              structName: "VisualTrack",
              associationField: "",
              associatedStructName: "",
              children: new Array<GongNode>()
            }
            VisualTracksGongNodeAssociation.children.push(visualtrackNode)
          })
