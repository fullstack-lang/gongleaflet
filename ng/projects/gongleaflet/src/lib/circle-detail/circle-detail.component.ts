...
export class CircleDetailComponent implements OnInit {
	...
	save(): void {
		...
		if (this.circle.LayerGroupID == undefined) {
			this.circle.LayerGroupID = new NullInt64
		}
		if (this.circle.LayerGroup != undefined) {
			this.circle.LayerGroupID.Int64 = this.circle.LayerGroup.ID
			this.circle.LayerGroupID.Valid = true
		} else {
			this.circle.LayerGroupID.Int64 = 0
			this.circle.LayerGroupID.Valid = true
		}
