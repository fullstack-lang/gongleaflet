...
func fillUpTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	case *models.DivIcon:
		fillUpTable[models.DivIcon](playground)
	case *models.LayerGroup:
		fillUpTable[models.LayerGroup](playground)
	case *models.LayerGroupUse:
		fillUpTable[models.LayerGroupUse](playground)
	case *models.MapOptions:
		fillUpTable[models.MapOptions](playground)
	case *models.Marker:
		fillUpTable[models.Marker](playground)
	case *models.UserClick:
		fillUpTable[models.UserClick](playground)
	case *models.VLine:
		fillUpTable[models.VLine](playground)
	case *models.VisualTrack:
		fillUpTable[models.VisualTrack](playground)
	default:
