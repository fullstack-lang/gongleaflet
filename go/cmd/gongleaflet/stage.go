...
func stageInjection(stage *models.StageStruct) {
	...
	__DivIcon__000001_Airport := (&models.DivIcon{Name: `Airport`}).Stage(stage)
	__DivIcon__000002_Airport := (&models.DivIcon{Name: `Airport`}).Stage(stage)
	__DivIcon__000003_Antena := (&models.DivIcon{Name: `Antena`}).Stage(stage)
	__DivIcon__000004_Arrow := (&models.DivIcon{Name: `Arrow`}).Stage(stage)
	__DivIcon__000005_Cross := (&models.DivIcon{Name: `Cross`}).Stage(stage)
	__DivIcon__000006_Dot10 := (&models.DivIcon{Name: `Dot10`}).Stage(stage)
	__DivIcon__000007_DotBlur := (&models.DivIcon{Name: `DotBlur`}).Stage(stage)
	__DivIcon__000008_Message := (&models.DivIcon{Name: `Message`}).Stage(stage)
	__DivIcon__000009_Radar := (&models.DivIcon{Name: `Radar`}).Stage(stage)
	__DivIcon__000010_Satellite := (&models.DivIcon{Name: `Satellite`}).Stage(stage)
	...
	__LayerGroup__000001_Default := (&models.LayerGroup{Name: `Default`}).Stage(stage)
	__LayerGroup__000002_Radar_Layer := (&models.LayerGroup{Name: `Radar Layer`}).Stage(stage)
	__LayerGroup__000003_Tracks_Layer := (&models.LayerGroup{Name: `Tracks Layer`}).Stage(stage)
	...
	__LayerGroupUse__000001_Map1RadarLayerUse := (&models.LayerGroupUse{Name: `Map1RadarLayerUse`}).Stage(stage)
	__LayerGroupUse__000002_Map1TracksLayerUse := (&models.LayerGroupUse{Name: `Map1TracksLayerUse`}).Stage(stage)
	__LayerGroupUse__000003_Map2RadarLayerUse := (&models.LayerGroupUse{Name: `Map2RadarLayerUse`}).Stage(stage)
	__LayerGroupUse__000004_Map2RadarLayerUse := (&models.LayerGroupUse{Name: `Map2RadarLayerUse`}).Stage(stage)
	__LayerGroupUse__000005_Map2TracksLayerUse := (&models.LayerGroupUse{Name: `Map2TracksLayerUse`}).Stage(stage)

	// Declarations of staged instances of MapOptions
	__MapOptions__000000_Map1 := (&models.MapOptions{Name: `Map1`}).Stage(stage)
	__MapOptions__000001_Map2 := (&models.MapOptions{Name: `Map2`}).Stage(stage)

	// Declarations of staged instances of Marker
	__Marker__000000_Dot := (&models.Marker{Name: `Dot`}).Stage(stage)
	__Marker__000001_Lyon_s_Airport := (&models.Marker{Name: `Lyon's Airport`}).Stage(stage)
	__Marker__000002_Lyon_s_Radar := (&models.Marker{Name: `Lyon's Radar`}).Stage(stage)
	...
	__VisualTrack__000001_Sat_Track := (&models.VisualTrack{Name: `Sat Track`}).Stage(stage)
...
`
	...
	// DivIcon values setup
	__DivIcon__000001_Airport.Name = `Airport`
	__DivIcon__000001_Airport.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
...
`
	...
	__DivIcon__000002_Airport.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?> <svg xmlns:dc="http://purl.org/dc/elements/1.1/"
   ...
   <g id="g891">
	...
	// DivIcon values setup
	__DivIcon__000003_Antena.Name = `Antena`
	__DivIcon__000003_Antena.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
...
`
	...
	// DivIcon values setup
	__DivIcon__000004_Arrow.Name = `Arrow`
	__DivIcon__000004_Arrow.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
   ...
   <path
	...
	// DivIcon values setup
	__DivIcon__000005_Cross.Name = `Cross`
	__DivIcon__000005_Cross.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg"
   ...
   <path
	...
	// DivIcon values setup
	__DivIcon__000006_Dot10.Name = `Dot10`
	__DivIcon__000006_Dot10.SVG = `<?xml version="1.0"?>
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:svgjs="http://svgjs.com/svgjs"
	...
	// DivIcon values setup
	__DivIcon__000007_DotBlur.Name = `DotBlur`
	__DivIcon__000007_DotBlur.SVG = `<?xml version="1.0"?>
...
`
	...
	// DivIcon values setup
	__DivIcon__000008_Message.Name = `Message`
	__DivIcon__000008_Message.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
...
`
	...
	// DivIcon values setup
	__DivIcon__000009_Radar.Name = `Radar`
	__DivIcon__000009_Radar.SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   xmlns:dc="http://purl.org/dc/elements/1.1/"
   xmlns:cc="http://creativecommons.org/ns#"
   xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
...
`
	...
	// DivIcon values setup
	__DivIcon__000010_Satellite.Name = `Satellite`
	__DivIcon__000010_Satellite.SVG = `<svg xmlns="http://www.w3.org/2000/svg"
   viewBox="0 0 410 410" >
...
<g transform="scale(1 1) translate(0 0)">
	...
	// LayerGroup values setup
	__LayerGroup__000001_Default.Name = `Default`
	__LayerGroup__000001_Default.DisplayName = ``

	// LayerGroup values setup
	__LayerGroup__000002_Radar_Layer.Name = `Radar Layer`
	__LayerGroup__000002_Radar_Layer.DisplayName = `Radar Layer`

	// LayerGroup values setup
	__LayerGroup__000003_Tracks_Layer.Name = `Tracks Layer`
	__LayerGroup__000003_Tracks_Layer.DisplayName = `Tracks Layer`
	...
	// LayerGroupUse values setup
	__LayerGroupUse__000001_Map1RadarLayerUse.Name = `Map1RadarLayerUse`
	__LayerGroupUse__000001_Map1RadarLayerUse.IsDisplayed = true

	// LayerGroupUse values setup
	__LayerGroupUse__000002_Map1TracksLayerUse.Name = `Map1TracksLayerUse`
	__LayerGroupUse__000002_Map1TracksLayerUse.IsDisplayed = true

	// LayerGroupUse values setup
	__LayerGroupUse__000003_Map2RadarLayerUse.Name = `Map2RadarLayerUse`
	__LayerGroupUse__000003_Map2RadarLayerUse.IsDisplayed = false

	// LayerGroupUse values setup
	__LayerGroupUse__000004_Map2RadarLayerUse.Name = `Map2RadarLayerUse`
	__LayerGroupUse__000004_Map2RadarLayerUse.IsDisplayed = false

	// LayerGroupUse values setup
	__LayerGroupUse__000005_Map2TracksLayerUse.Name = `Map2TracksLayerUse`
	__LayerGroupUse__000005_Map2TracksLayerUse.IsDisplayed = false
	...
	// MapOptions values setup
	__MapOptions__000001_Map2.Lat = 45.000000
	__MapOptions__000001_Map2.Lng = 3.000000
	__MapOptions__000001_Map2.Name = `Map2`
	__MapOptions__000001_Map2.ZoomLevel = 5.000000
	__MapOptions__000001_Map2.UrlTemplate = `https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png`
	__MapOptions__000001_Map2.Attribution = `osm`
	__MapOptions__000001_Map2.MaxZoom = 18
	__MapOptions__000001_Map2.ZoomControl = false
	__MapOptions__000001_Map2.AttributionControl = false
	__MapOptions__000001_Map2.ZoomSnap = 1
	...
	// Marker values setup
	__Marker__000001_Lyon_s_Airport.Lat = 46.000000
	__Marker__000001_Lyon_s_Airport.Lng = 5.500000
	__Marker__000001_Lyon_s_Airport.Name = `Lyon's Airport`
	__Marker__000001_Lyon_s_Airport.ColorEnum = models.GREEN

	// Marker values setup
	__Marker__000002_Lyon_s_Radar.Lat = 46.000000
	__Marker__000002_Lyon_s_Radar.Lng = 5.000000
	__Marker__000002_Lyon_s_Radar.Name = `Lyon's Radar`
	__Marker__000002_Lyon_s_Radar.ColorEnum = models.BLUE
	...
	__VisualTrack__000000_Plane_Track.Lat = 43.200983
	__VisualTrack__000000_Plane_Track.Lng = 4.587785
	__VisualTrack__000000_Plane_Track.Heading = 594.000000
	__VisualTrack__000000_Plane_Track.Level = 211.755705
	__VisualTrack__000000_Plane_Track.Speed = 311.755705
	...
	// VisualTrack values setup
	__VisualTrack__000001_Sat_Track.Lat = 45.000000
	__VisualTrack__000001_Sat_Track.Lng = 5.000000
	__VisualTrack__000001_Sat_Track.Heading = 130.000000
	__VisualTrack__000001_Sat_Track.Level = 200.000000
	__VisualTrack__000001_Sat_Track.Speed = 300.000000
	__VisualTrack__000001_Sat_Track.VerticalSpeed = 30.000000
	__VisualTrack__000001_Sat_Track.Name = `Sat Track`
	__VisualTrack__000001_Sat_Track.ColorEnum = models.GREEN
	__VisualTrack__000001_Sat_Track.DisplayTrackHistory = true
	__VisualTrack__000001_Sat_Track.DisplayLevelAndSpeed = true

	// Setup of pointers
	__Circle__000000_Lyon_s_Radar_Range.LayerGroup = __LayerGroup__000002_Radar_Layer
	__LayerGroupUse__000000_Map1AirportLayerUse.LayerGroup = __LayerGroup__000000_Airport_Layer
	__LayerGroupUse__000001_Map1RadarLayerUse.LayerGroup = __LayerGroup__000002_Radar_Layer
	__LayerGroupUse__000002_Map1TracksLayerUse.LayerGroup = __LayerGroup__000003_Tracks_Layer
	__LayerGroupUse__000003_Map2RadarLayerUse.LayerGroup = __LayerGroup__000000_Airport_Layer
	__LayerGroupUse__000004_Map2RadarLayerUse.LayerGroup = __LayerGroup__000002_Radar_Layer
	__LayerGroupUse__000005_Map2TracksLayerUse.LayerGroup = __LayerGroup__000003_Tracks_Layer
	...
	__MapOptions__000000_Map1.LayerGroupUses = append(__MapOptions__000000_Map1.LayerGroupUses, __LayerGroupUse__000001_Map1RadarLayerUse)
	__MapOptions__000000_Map1.LayerGroupUses = append(__MapOptions__000000_Map1.LayerGroupUses, __LayerGroupUse__000002_Map1TracksLayerUse)
	__MapOptions__000001_Map2.LayerGroupUses = append(__MapOptions__000001_Map2.LayerGroupUses, __LayerGroupUse__000003_Map2RadarLayerUse)
	__MapOptions__000001_Map2.LayerGroupUses = append(__MapOptions__000001_Map2.LayerGroupUses, __LayerGroupUse__000004_Map2RadarLayerUse)
	__MapOptions__000001_Map2.LayerGroupUses = append(__MapOptions__000001_Map2.LayerGroupUses, __LayerGroupUse__000005_Map2TracksLayerUse)
	__Marker__000000_Dot.LayerGroup = __LayerGroup__000002_Radar_Layer
	__Marker__000000_Dot.DivIcon = __DivIcon__000006_Dot10
	__Marker__000001_Lyon_s_Airport.LayerGroup = __LayerGroup__000000_Airport_Layer
	__Marker__000001_Lyon_s_Airport.DivIcon = __DivIcon__000001_Airport
	__Marker__000002_Lyon_s_Radar.LayerGroup = __LayerGroup__000002_Radar_Layer
	__Marker__000002_Lyon_s_Radar.DivIcon = __DivIcon__000009_Radar
	__VLine__000000_Test_line.LayerGroup = __LayerGroup__000002_Radar_Layer
	__VisualTrack__000000_Plane_Track.LayerGroup = __LayerGroup__000003_Tracks_Layer
	__VisualTrack__000000_Plane_Track.DivIcon = __DivIcon__000000_Airplane
	__VisualTrack__000001_Sat_Track.LayerGroup = __LayerGroup__000003_Tracks_Layer
	__VisualTrack__000001_Sat_Track.DivIcon = __DivIcon__000010_Satellite
}
