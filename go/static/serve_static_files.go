...
import (
	...
	"github.com/fullstack-lang/gongleaflet"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongleaflet.NgDistNg, "ng-github.com-fullstack-lang-gongleaflet/dist/ng-github.com-fullstack-lang-gongleaflet/browser")))
