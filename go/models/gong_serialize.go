...
func SerializeStage(stage *StageStruct, filename string) {
	...
	{
		// insertion point
		SerializeExcelizePointerToGongstruct[*Circle](stage, f)
		SerializeExcelizePointerToGongstruct[*DivIcon](stage, f)
		SerializeExcelizePointerToGongstruct[*LayerGroup](stage, f)
		SerializeExcelizePointerToGongstruct[*LayerGroupUse](stage, f)
		SerializeExcelizePointerToGongstruct[*MapOptions](stage, f)
		SerializeExcelizePointerToGongstruct[*Marker](stage, f)
		SerializeExcelizePointerToGongstruct[*UserClick](stage, f)
		SerializeExcelizePointerToGongstruct[*VLine](stage, f)
		SerializeExcelizePointerToGongstruct[*VisualTrack](stage, f)
	}
